...
``virulence.csv``: filtered ``virulence_factors.csv`` file for duplicated entries (locus tags). **VAGs_category** column is added according to [Liao, 2022](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC9299443/pdf/fcimb-12-926758.pdf), [Qin, 2022](https://www.nature.com/articles/s41392-022-01056-1#Sec2), and other references (described in [google drive document](https://docs.google.com/document/d/1iTYGDTxvpvSbcZ8BFUL_5PmAXkW_ZDvjt5xrFocSmH0/edit?tab=t.0))
